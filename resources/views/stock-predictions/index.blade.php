...
@empty<tr><td colspan="7"><div class="empty-state"><i class="ti-stats-up"></i><h3>Belum ada hasil prediksi</h3><p>Admin atau Manager dapat menjalankan analisis untuk mulai melihat rekomendasi.</p></div></td></tr>@endforelse</tbody></table></div>@if($predictions->hasPages())<div class="pagination-wrap">{{ $predictions->links() }}</div>@endif</x-ui.card>
@endsection
